    ...
    \label{sec:preparation-classicality}
        ...
        \label{sec:nonclassicality-activation}
			...
			\begin{figure*}[t!]
				...
				\centering
				%
				\subfigure[Preparations]{\label{fig:preparation-set-activation}\includegraphics[width=.4\linewidth]{preparation-states.png}}\hfill
				\subfigure[Activation]{\label{fig:nonclassicality-activation}\includegraphics[width=.58\linewidth]{preparation-activation.png}}\hfill
				%
    ...
    \label{sec:measurement-classicality}
        ...
        \label{sec:incompatibility-vs-classicality}
			...
			\begin{figure*}[t!]
				...
				\centering
				%
				\subfigure[]{\label{fig:mirror-symmetric-measurements}\includegraphics[width=.4\linewidth]{mirror-symmetric-measurements.png}}\hfill
				\subfigure[]{\label{fig:incompatibility-vs-classicality}\includegraphics[width=.58\linewidth]{incompatibility-vs-classicality.png}}\hfill
				%
