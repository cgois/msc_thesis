...
\thispagestyle{empty}  % Remove opening page number
	...
	\section{Gell-Mann operators and Bloch vectors}
		...
		In sec. \ref{sec:density-operator} we argued that any quantum state is a linear, positive semi-definite, unit-trace $d$-dimensional density operator $\rho$, and that any such $\rho$ is a quantum state. Thus we defined the set of density operators as
		%
		$$
